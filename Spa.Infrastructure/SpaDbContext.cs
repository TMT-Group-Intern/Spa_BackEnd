...
namespace Spa.Infrastructure
{
    ...
    public class BloggingContextFactory : IDesignTimeDbContextFactory<SpaDbContext>
    {
        public SpaDbContext CreateDbContext(string[] args)
        {
            ...
            optionsBuilder.UseSqlServer("Data Source=fuco;Initial Catalog=SpaShop5;Persist Security Info=True;User ID=sa;Password=fuco;Trust Server Certificate=True");
