...
namespace Spa.Infrastructure.Migrations
{
    ...
    [Migration("20240819041705_addcollumistreatmentBillItem")]
    partial class addcollumistreatmentBillItem
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Spa.Domain.Entities.ChooseServiceTreatment", b =>
                {
                    b.Property<long>("TreatmentDetailID")
                        .HasColumnType("bigint");
                    ...
                    b.Property<int>("QualityChooses")
                        .HasColumnType("int");

                    b.HasKey("TreatmentDetailID", "AppointmentID");

                    b.HasIndex("AppointmentID");

                    b.ToTable("ChooseServiceTreatment");
                });
            ...
            modelBuilder.Entity("Spa.Domain.Entities.TreatmentDetail", b =>
                {
                    b.Property<long?>("TreatmentDetailID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Spa.Domain.Entities.ChooseServiceTreatment", b =>
                {
                    b.HasOne("Spa.Domain.Entities.Appointment", "Appointment")
                        .WithMany("ChooseServiceTreatments")
                        .HasForeignKey("AppointmentID")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Spa.Domain.Entities.TreatmentDetail", "TreatmentDetail")
                        .WithMany("ChooseServiceTreatment")
                        .HasForeignKey("TreatmentDetailID")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("Spa.Domain.Entities.Appointment", b =>
                {
                    ...
                    b.Navigation("ChooseServiceTreatments");
            ...
            modelBuilder.Entity("Spa.Domain.Entities.TreatmentDetail", b =>
                {
                    b.Navigation("ChooseServiceTreatment");
                });
